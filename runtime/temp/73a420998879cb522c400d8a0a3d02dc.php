<?php /*a:1:{s:62:"C:\xampp\htdocs\ggshop06\application\admin\view\index\top.html";i:1630071902;}*/ ?>
...
<div id="header-div">
	...
	<div id="submenu-div">
		<ul>
			  <!--<li><a href="<?php echo url('logout'); ?>" target="main-frame">退出</a></li>-->
			  <li><a href="<?php echo url('Login/logout'); ?>" target="_top">退出</a></li>
