<?php /*a:1:{s:63:"C:\xampp\htdocs\ggshop06\application\admin\view\index\menu.html";i:1630071764;}*/ ?>
	...
	<div id="main-div">
		<div id="menu-list">
			<ul id="menu-ul">
                            ...
                            <li class="explode" key="02_cat_and_goods" name="menu"> <?php echo htmlentities($menu['menu_name']); ?>        
					<ul>
						 <?php foreach($menu['son'] as $son): ?>
						  <li class="menu-item"><a href="<?php echo url( $son['ctl'] . '/' .$son['act']); ?>" target="main-frame"><?php echo htmlentities($son['menu_name']); ?></a></li>
                                                  <?php endforeach; ?>
